...
class FlickrAPI {
    ...
    func searchURL(for coordinate: CLLocationCoordinate2D) -> URL? {
        let stringURL = "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(key)&sort=date-posted-desc&lat=\(coordinate.latitude)&lon=\(coordinate.longitude)&per_page=8&format=json&nojsoncallback=1"
